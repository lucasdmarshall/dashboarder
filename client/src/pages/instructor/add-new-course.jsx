...
function AddNewCoursePage() {
  ...
  function validateFormData() {
    ...
    // Check landing form data
    for (const key in courseLandingFormData) {
      if (isEmpty(courseLandingFormData[key])) {
        console.log("Empty landing form field:", key);
        return false;
      }
    }
    ...
    for (const item of courseCurriculumFormData) {
      console.log("Checking curriculum item:", item);
      if (
        isEmpty(item.title) ||
        isEmpty(item.videoUrl) ||
        isEmpty(item.public_id)
      ) {
        console.log("Empty curriculum field in item:", item);
        return false;
      }
    ...
    return hasFreePreview && courseCurriculumFormData.length > 0;
  }
